...
#ifndef ALAMOFIREDEMO_SWIFT_H
#define ALAMOFIREDEMO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AlamofireDemo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13AlamofireDemo11AppDelegate")
...
SWIFT_CLASS("_TtC13AlamofireDemo10CustomCell")
...
SWIFT_CLASS("_TtC13AlamofireDemo13SceneDelegate")
...
SWIFT_CLASS("_TtC13AlamofireDemo14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(AlamofireDemo)) <UITableViewDataSource, UITableViewDelegate>
